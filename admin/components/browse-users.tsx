...
async function deleteUser(uInfo: UserInfo, state: BrowseUsersProps, setState: Dispatch<SetStateAction<BrowseUsersProps>>) {
  ...
  setState({
    ...
    fetchState: 'filterChanged',
    regStatusFilter: state.regStatusFilter
  });
}
...
async function fetchUsers(regStatusFilter: string = 'done'): Promise<UserInfo[]> {
  ...
  try {
    ...
    const { data } = await callGraphQLWithSimpleInput<UserInfoByRegStatusQuery>(graphQlParams);

    items = data?.userInfoByRegStatus?.items as UserInfo[];
  } catch (error) {
          ...
          <ol className="breadcrumb">
            <li className="breadcrumb-item">
              <a href="#"
                 ...
                 onClick={() => propsWithStateInfo.setState({
                   userList: propsWithStateInfo.props.userList,
                   selectedUser: {} as UserInfo,
                   fetchState: propsWithStateInfo.props.fetchState,
                   regStatusFilter: propsWithStateInfo.props.regStatusFilter
                 })}>
                Users
              </a>
            </li>
...
const UserEntry = (uRowWithStateInfo: UserRowWithStateInfo) => {
  ...
  return (
    <a href="#"
       onClick={() => uRowWithStateInfo.setState({
         userList: uRowWithStateInfo.props.userList,
         selectedUser: uInfo,
         fetchState: uRowWithStateInfo.props.fetchState,
         regStatusFilter: uRowWithStateInfo.props.regStatusFilter
       })}
