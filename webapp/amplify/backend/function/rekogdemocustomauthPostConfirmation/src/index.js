...
/* Amplify Params - DO NOT EDIT
    API_PASSPRINTGRAPHQL_GRAPHQLAPIIDOUTPUT
    API_PASSPRINTGRAPHQL_USERTABLE_ARN
    API_PASSPRINTGRAPHQL_USERTABLE_NAME
    ENV
    REGION
Amplify Params - DO NOT EDIT */
/**
 ...
 * `MODULES` env var.
 */
var moduleNames = process.env.MODULES ? process.env.MODULES.split(',') : [];
/**
...
exports.handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
             ...
             */
            return [4 /*yield*/, Promise.all(modules.map(function (module) { return module.handler(event, context); }))];
            case 1:
                /**
                 * Instead of naively iterating over all handlers, run them concurrently with
                 * `await Promise.all(...)`. This would otherwise just be determined by the
